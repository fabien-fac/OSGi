		...
		Display.getDefault().asyncExec(new Runnable() {
		    public void run() {
				...
				case CLOUDY:
					...
					break;
				case RAINY:
					lblNewLabel.setImage(SWTResourceManager.getImage(LocationDisplay.class, "/org/ups/weather/affichage/images/RAINY.png"));
					break;
				case SHINY:
					lblNewLabel.setImage(SWTResourceManager.getImage(LocationDisplay.class, "/org/ups/weather/affichage/images/SHINY.png"));
					break;
				case SHOWERS:
					lblNewLabel.setImage(SWTResourceManager.getImage(LocationDisplay.class, "/org/ups/weather/affichage/images/SHOWERS.png"));
					break;
				case SNOW:
					lblNewLabel.setImage(SWTResourceManager.getImage(LocationDisplay.class, "/org/ups/weather/affichage/images/SNOW.png"));
					break;
				case UNKNOWN:
					lblNewLabel.setImage(SWTResourceManager.getImage(LocationDisplay.class, "/org/ups/weather/affichage/images/UNKNOWN.png"));
					break;
				default:
					break;
				}
